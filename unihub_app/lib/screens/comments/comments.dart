    ...
    return FutureBuilder<List<Comment>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            return WillPopScope(
                onWillPop: () {
                  Navigator.of(context).pop(this.commentsList);
                },
                child: Scaffold(
                  appBar: AppBar(
                    title: Text(AppLocalizations.instance
                        .text("comments_feedDetail", null)),
                    leading: IconButton(
                      icon: Icon(
                        Icons.arrow_back,
                        color: Colors.white,
                      ...
                      suffixIcon: IconButton(
                        ...
                        onPressed: () async {
                          if (contentController.text != '') {
                            ...
                            if (response.statusCode == 200) {
                              createToast(
                                  AppLocalizations.instance
                                      .text("comments_commentCreatedOK", null),
                                  Colors.green);
                              setState(() {
                            ...
                            createToast(
                                AppLocalizations.instance
                                    .text("comments_commentError", null),
                                Colors.yellow);
                          }
                        },
                      ),
                      hintText: AppLocalizations.instance
                          .text("comments_newComment", null),
                      hintStyle:
            ...
            return WillPopScope(
                ...
                child: Scaffold(
                  ...
                  body: SafeArea(
                    ...
                    padding: EdgeInsets.fromLTRB(10, 0, 10, 0),
                    child: FeedPost(
                        this.widget.feedPublication, this.widget.username),
                  )),
                  bottomSheet: TextField(
                    style: TextStyle(color: Colors.grey[800], fontSize: 14.0),
                    controller: contentController,
  ...
  showDeletePostAlertDialog(BuildContext context, Comment comment) {
    ...
    AlertDialog alert = AlertDialog(
        content: Text(AppLocalizations.instance
            .text("comments_deleteConfirmation", null)),
